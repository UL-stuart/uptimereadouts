# Snipe Hunt — Initial Cohort vs All Runs Comparison

This report compares the **initial cohort after removing the two early Swetha runs** against the performance of the full attached cohort of all Snipe Hunt runs.

The initial comparison set contains **7 sessions**: `9150`, `9196`, `9317`, `9380`, `9397`, `9418`, and `9421`.

The full cohort contains **124 sessions**.

## Headline Comparison

| Metric | Initial cohort | All runs | Difference |
|---|---:|---:|---:|
| Sessions | 7 | 124 | — |
...
The initial cohort is around **0.23 points lower** on both mean facet and mean marker scores. On a 1–4 scoring scale, that is a meaningful but not catastrophic gap. The initial group sits in a “developing / practicing” band, while the full cohort has moved closer to a stronger “practicing+” level.

## Facet Comparison

| Facet | Initial cohort | All runs | Difference |
|---|---:|---:|---:|
...
The interesting result is **F1 is identical**. The initial cohort was no worse than the full cohort at dealing with misleading correlations, at least on average. That suggests the early group’s problem was not simply that they chased the wrong thing more than everyone else.
...
| Marker Group | Initial cohort | All runs | Difference |
|---|---:|---:|---:|
...
**M5 — Adapts approach when initial path isn’t working** is also materially lower at **-0.35**. Combined with the F2 gap, this suggests the initial cohort was more likely to stay in the original frame after a failed action, rather than treating failure as diagnostic information.

## Interpretation

The initial cohort looks like a group that could **engage**, **ask clarifying questions**, and **communicate at a basic level**, but was less strong at turning that engagement into structured incident command.
...
For the initial cohort, the biggest development focus would be **“from asking to structuring.”**
